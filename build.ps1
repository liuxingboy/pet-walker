...
& $petCompiler /nologo /target:winexe /platform:x64 /optimize+ /utf8output /out:"$PSScriptRoot\HydrangeaWalker.exe" /win32icon:"$PSScriptRoot\icons\app.ico" /resource:"$PSScriptRoot\icons\app.ico,HydrangeaWalker.Icon" /reference:System.Security.dll /reference:System.dll /reference:System.Core.dll /reference:System.Drawing.dll /reference:System.Windows.Forms.dll /reference:System.Web.Extensions.dll "$PSScriptRoot\PetWalker.cs" "$PSScriptRoot\Reminder.cs" "$PSScriptRoot\Todo.cs"
